...
static const char *defaultcolors[][3]      = {
	...
	[SchemeSel]  = { col_gray4, col_mint,  col_mint  },
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_mint, "-sf", col_gray4, NULL };
